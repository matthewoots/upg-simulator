...
namespace RosMessageTypes.Sensor
{
    ...
    public class BatteryStateMsg : Message
    {
        ...
        public BatteryStateMsg(HeaderMsg header, float voltage, float current, float charge, float capacity, float design_capacity, float percentage, byte power_supply_status, byte power_supply_health, byte power_supply_technology, bool present, float[] cell_voltage, string location, string serial_number)
        {
            this.header = header;
