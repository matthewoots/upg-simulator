...
{
    public class MState : Message
    {
        public const string RosMessageName = "mavros_msgs/State";
        ...
        public MState(Std.MHeader header, bool connected, bool armed, bool guided, bool manual_input, string mode, byte system_status)
        {
            this.header = header;
        ...
        public override List<byte[]> SerializationStatements()
        {
            ...
            listOfSerializations.Add(BitConverter.GetBytes(this.armed));
            listOfSerializations.Add(BitConverter.GetBytes(this.guided));
            listOfSerializations.Add(BitConverter.GetBytes(this.manual_input));
        ...
        public override int Deserialize(byte[] data, int offset)
        {
            ...
            offset += 1;
            this.armed = BitConverter.ToBoolean(data, offset);
            offset += 1;
            this.guided = BitConverter.ToBoolean(data, offset);
            offset += 1;
            this.manual_input = BitConverter.ToBoolean(data, offset);
            offset += 1;
